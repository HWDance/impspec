...
def main(seed, n=100, n_int=100, niter = 1000, learn_rate = 0.1,
    ...
    var = model.post_var(Y, A, V, W=W, doA = doA, doW = doW, reg = reg, nu = nu_best, diag = True).detach()
    ...
    if front_door:
        ...
        obs_data = [W,Y]
        int_data = [doW,EYdoX]   
    return {"name" : "causalklgp_cal={0}_split={1}_frontdoor={2}_minimise={3}".format(False, False, front_door,minimise),
                "rmse" : rmse, 
